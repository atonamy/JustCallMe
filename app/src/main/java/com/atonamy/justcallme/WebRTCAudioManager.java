...
public class WebRTCAudioManager {
    ...
    private WebRTCProximitySensor proximitySensor = null;
    ...
    /** Construction */
    static WebRTCAudioManager create(Context context,
                                     Runnable deviceStateChangeListener) {
        return new WebRTCAudioManager(context, deviceStateChangeListener);
    }
    ...
    private WebRTCAudioManager(Context context,
        ...
        proximitySensor = WebRTCProximitySensor.create(context, new Runnable() {
