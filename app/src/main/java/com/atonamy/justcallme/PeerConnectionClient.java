...
import com.atonamy.justcallme.utils.LooperExecutor;
...
public class PeerConnectionClient {
    ...
    private static final String AUDIO_ECHO_KILLER_CONSTRAINT = "googDAEchoCancellation";
    ...
    private void createMediaConstraintsInternal() {
        ...
        // pcConstraints.mandatory.add(new MediaConstraints.KeyValuePair("googNoiseSuppression", "true"));
        ...
        audioConstraints.mandatory.add(new KeyValuePair(
                AUDIO_ECHO_KILLER_CONSTRAINT , "true"));

        //}
        // Create SDP constraints.
        sdpMediaConstraints = new MediaConstraints();
        // sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair("googNoiseSuppression", "true"));
